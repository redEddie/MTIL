import os
import sys
sys.path.insert(0, os.path.dirname(__file__))                   # test/
...
checkpoint = '/home/jeonchanwook/MTIL.main/logs/main/transfer20/lightning_logs/version_5/checkpoints/last.ckpt'  # your own path
